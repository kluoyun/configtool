<template>
	<b-container>
		...
		<b-card v-if="template.standalone && board.hasESP" header="ESP Settings">
			<b-form-checkbox v-model="wifiEnabled" v-preset.left="preset.wifi.enabled" title="Check this to enable networking features (M552 S1) using an ESP">Enable Network using ESP8266</b-form-checkbox>
			<div v-show="wifiEnabled" class="pl-4">
				<b-form-row class="mt-3">
					<b-col>
						<b-form-group label="Password for the web interface (HTTP), FTP, and Telnet:">
							<b-form-input v-model.trim="password" v-b-tooltip.hover title="Optional password to protect your printer from others on your local network (M551)" maxlength="64" placeholder="reprap" type="text"></b-form-input>
				...
				<b-form-row>
					<b-form-group label="Pin settings for ESP8266:">
					</b-form-group>
				</b-form-row>
				<b-form-row>
						<b-col>
							<b-form-group label="espDataReadyPin:">
								<b-form-input v-model.number="espDataReadyPin" v-preset="preset.wifi8266.espDataReadyPin" title="This is the pin to be used in board.txt for 8266wifi.espDataReadyPin" type="text" maxlength="4" required></b-form-input>
							</b-form-group>
						</b-col>
						<b-col>
							<b-form-group label="lpcTfrReadyPin:">
								<b-form-input v-model.number="lpcTfrReadyPin" v-preset="preset.wifi8266.lpcTfrReadyPin" title="This is the pin to be used in board.txt for 8266wifi.lpcTfrReadyPin" type="text" maxlength="4" required></b-form-input>
							</b-form-group>
						</b-col>
						<b-col>
							<b-form-group label="espResetPin:">
								<b-form-input v-model.number="espResetPin" v-preset="preset.wifi8266.espResetPin" title="This is the pin to be used in board.txt for 8266wifi.espResetPin" type="text" maxlength="4" required></b-form-input>
							</b-form-group>
						</b-col>
				</b-form-row>
...
export default {
	computed: {
		...
		...mapFields({
			...
			wifiEnabled: 'template.wifi.enabled',
			...
			espDataReadyPin: 'template.wifi.espDataReadyPin',
			lpcTfrReadyPin: 'template.wifi.lpcTfrReadyPin',
			espResetPin: 'template.wifi.espResetPin'

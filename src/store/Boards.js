...
export default {
    ...
    },
    {
        ...
        microsteppingInterpolation: true,
        numDrives: 11,
        heaterPorts: ['bed', 'e0heat', 'e1heat','e2heat','e3heat','e4heat','e5heat','e6heat','e7heat'],
        fanPorts: ['fan0','fan1','fan2','fan_M1','fan_M2','fan_M3','fan_M4','fan_M5'],
        pwmPorts: ['bed', 'e0heat', 'e1heat','e2heat','e3heat','e4heat','e5heat','e6heat','e7heat','fan0','fan1','fan2','fan_M1','fan_M2','fan_M3','fan_M4','fan_M5'],
        gpioPorts: ['xstop','ystop','zstop', 'e0stop','e1stop','e2stop','e3stop','e4stop','e5stop','e6stop','e7stop','probe','EI1','EI2'],
        analogPorts: ['bedtemp', 'e0temp', 'e1temp','e2temp','e3temp','e4temp','e5temp','e6temp','e7temp'],
        blPorts: ['servo0'],
        spiCsPorts: [],
        hasEthernet: false,
        hasWiFi: false,
